...
*/
	enum OPENCITY_STRUCTURE_TYPE {
		OC_STRUCTURE_UNUSEDTYPE,
		OC_STRUCTURE_RESIDENCE,
		OC_STRUCTURE_COMMERCE,
		OC_STRUCTURE_INDUSTRY,
		OC_STRUCTURE_WATER,
		OC_STRUCTURE_ELECTRICITY,
		OC_STRUCTURE_GAS,
		OC_STRUCTURE_PATH,
		OC_STRUCTURE_GOVERNMENT
	};
